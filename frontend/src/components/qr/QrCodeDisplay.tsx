      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div className="bg-gray-50 rounded-lg p-4">
            <div className="flex items-center justify-between mb-2">
              ...
              <button
                ...
                className="text-xs text-primary-600 hover:text-primary-700 flex items-center gap-1 transition-colors duration-200"
              >
                {copied ? (
          ...
          <div className="bg-primary-50 border border-primary-200 rounded-lg p-3 mt-4">
            <p className="text-xs font-medium text-primary-900 mb-1">{t('qr.proTipsTitle')}</p>

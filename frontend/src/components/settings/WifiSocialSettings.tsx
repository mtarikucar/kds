...
import { Wifi, Share2, Save, Loader2, Eye, EyeOff } from 'lucide-react';
...
export default function WifiSocialSettings() {
  ...
  const handleSave = () => {
    updateSettings.mutate(
      ...
      {
        onSuccess: () => {
          toast.success(t('wifiSocialSettings.saved'));
          setHasChanges(false);
        },
        onError: () => {
      ...
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h3 className="text-lg font-semibold text-gray-900">
            {t('wifiSocialSettings.title')}
          </h3>
          <p className="text-sm text-gray-500">
            {t('wifiSocialSettings.description')}
          </p>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input
              type="text"
              value={wifiSsid}
              onChange={handleInputChange(setWifiSsid)}
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                value={wifiPassword}
                onChange={handleInputChange(setWifiPassword)}
              ...
              <button
                ...
                title={showPassword ? t('wifiSocialSettings.hidePassword') : t('wifiSocialSettings.showPassword')}
              >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1">
              ...
              {t('wifiSocialSettings.instagram')}
            </label>
            <input
              type="text"
              value={socialInstagram}
              onChange={handleInputChange(setSocialInstagram)}
          ...
          <div>
            ...
            <input
              ...
              onChange={handleInputChange(setSocialFacebook)}
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1">
              <span className="text-gray-900"><TwitterIcon /></span>
              {t('wifiSocialSettings.twitter')}
            </label>
            <input
              type="text"
              value={socialTwitter}
              onChange={handleInputChange(setSocialTwitter)}
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1">
              <span className="text-gray-900"><TikTokIcon /></span>
              {t('wifiSocialSettings.tiktok')}
            </label>
            <input
              type="text"
              value={socialTiktok}
              onChange={handleInputChange(setSocialTiktok)}
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1">
              ...
              {t('wifiSocialSettings.youtube')}
            </label>
            <input
              type="text"
              value={socialYoutube}
              onChange={handleInputChange(setSocialYoutube)}
          ...
          <div>
            <label className="flex items-center gap-2 text-sm font-medium text-gray-700 mb-1">
              ...
              {t('wifiSocialSettings.whatsapp')}
            </label>
            <input
              type="text"
              value={socialWhatsapp}
              onChange={handleInputChange(setSocialWhatsapp)}

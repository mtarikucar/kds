...
import { MODULES } from "../../marketing/data/modules";

/** /ozellikler — index of all module deep-dive pages. */
    ...
    <MarketingLayout>
      <section className="ht-grain relative mx-auto max-w-6xl px-5 pb-4 pt-16 text-center sm:pt-20">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-lg leading-relaxed text-[#57534e]">
          QR menüden çoklu şubeye, mutfak ekranından stok yönetimine kadar her
          modül birbiriyle konuşur. Detaylar için modüle tıklayın.
        </p>
      </section>

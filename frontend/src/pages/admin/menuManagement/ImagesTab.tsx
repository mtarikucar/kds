        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          ...
          <div
            ...
            className={cn(
              ...
              (isProcessing || uploadImagesMutation.isPending) &&
          ...
          >
            ...
            <label htmlFor="image-upload" className="cursor-pointer">
              ...
              <p className="mt-2 text-sm text-slate-600">
                {uploadImagesMutation.isPending
                  ? t("menu.imageLibraryUI.uploading")
                  : t("menu.imageLibraryUI.dropOrClick")}
              </p>
              <p className="mt-1 text-xs text-slate-400">
                {t("menu.imageLibraryUI.uploadHint")}
              </p>
            </label>
          </div>
        </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-slate-900">
                    {t("menu.imageLibraryUI.removeBg")}
                  </p>
                  <p className="text-xs text-slate-500">
                    {t("menu.imageLibraryUI.aiPowered")}
                  </p>
                </div>
              </div>
              <button
              ...
              <div className="mt-3 p-2 bg-violet-50 rounded-lg">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-xs text-violet-700">
                    {isModelLoading
                      ? t("menu.imageLibraryUI.loadingModel")
                      : processingFile}
                  </span>
                </div>
              </div>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-4">
          ...
          {isUnusedView && (
            <p className="mt-2 text-xs text-slate-500">
              {t("menu.imageLibraryUI.unusedHint")}
            </p>
          )}
        </div>
              ...
              {filteredImages.map((image) => (
                ...
                >
                  ...
                  <div
                    ...
                    style={{
                      background:
                        "repeating-conic-gradient(#f3f4f6 0% 25%, #fff 0% 50%) 50% / 6px 6px",
                    }}
                  >
                    {image.mimeType?.startsWith("video") ? (
                      <video

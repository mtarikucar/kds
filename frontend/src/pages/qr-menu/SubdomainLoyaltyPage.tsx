...
interface SubdomainLoyaltyPageProps {
  subdomain: string;
}

const SubdomainLoyaltyPage: React.FC<SubdomainLoyaltyPageProps> = ({ subdomain }) => {
  ...
  return (
    <QRMenuLayout currentPage="loyalty" onMenuDataLoaded={setMenuData} onSessionIdChange={setSessionId} subdomain={subdomain}>
      {menuData && (
        <LoyaltyContent
...
export default SubdomainLoyaltyPage;

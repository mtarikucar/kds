  ...
  if (!currentSubscription) {
    return (
      <div className="max-w-2xl mx-auto text-center py-12">
        ...
        <h2 className="text-2xl font-bold text-slate-900 mb-2">{t('subscriptions.noActiveSubscription')}</h2>
        ...
        <CardContent>
          ...
          {currentPlan && (
            <div className="mt-6 pt-6 border-t">
              <h4 className="font-semibold text-slate-900 mb-3">{t('subscriptions.planLimitsFeatures')}</h4>
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div>
                  <p className="text-sm text-slate-500">{t('subscriptions.planLimits.users')}</p>
                ...
                <div>
                  <p className="text-sm text-slate-500">{t('subscriptions.planLimits.tables')}</p>
                  <p className="font-semibold">
                ...
                <div>
                  <p className="text-sm text-slate-500">{t('subscriptions.planLimits.products')}</p>
                  <p className="font-semibold">
                ...
                <div>
                  <p className="text-sm text-slate-500">{t('subscriptions.planLimits.monthlyOrders')}</p>
                  <p className="font-semibold">
      ...
      <Card>
        ...
        <CardContent>
          {invoicesLoading ? (
            ...
            <p className="text-slate-500 text-center py-8">{t('subscriptions.noInvoicesYet')}</p>
          ) : (

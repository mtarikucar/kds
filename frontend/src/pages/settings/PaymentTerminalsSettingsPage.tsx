...
export const PaymentTerminalsPanel = () => {
  ...
  return (
    <div className="max-w-3xl space-y-6">
      {/* Register button — page header chrome lives with the caller now
          (this panel is embedded in the branch hub's Terminals tab), but the
          register action must stay reachable. */}

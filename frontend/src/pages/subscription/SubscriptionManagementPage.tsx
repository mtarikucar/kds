  ...
  return (
    <div className="max-w-6xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-900">{t('subscriptions.management')}</h1>
        <Button variant="outline" onClick={() => navigate('/subscription/plans')}>
          {t('subscriptions.viewAllPlansBtn')}
        </Button>
      </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="text-lg font-semibold text-gray-900 mb-4">
                {currentSubscription.plan?.displayName || t('subscriptions.unknownPlan')}
              </h3>
              <div className="space-y-3">
                ...
                <div className="flex items-center text-sm">
                  ...
                  <span className="text-gray-600">
                    {t('subscriptions.nextBilling')}: {formatDate(currentSubscription.currentPeriodEnd)}
                  </span>
                </div>

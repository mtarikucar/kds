...
export default function ReferralCodeCard() {
  ...
  return (
    <div className="rounded-2xl border border-indigo-200 bg-gradient-to-r from-indigo-50 to-white p-6">
      <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2 flex items-center gap-3">
            <code className="rounded-lg bg-white border border-indigo-200 px-3 py-2 font-mono text-2xl font-bold tracking-wider text-indigo-900">
              {code}
            </code>
            <button
              type="button"
      ...
      {isManager && (
        <div className="mt-4 pt-4 border-t border-indigo-100 flex items-center justify-end">
          <button
            type="button"
            onClick={() => {
              if (

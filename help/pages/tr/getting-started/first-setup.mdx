...
<Callout type="info">
  Kontrol listesi **bağlama duyarlıdır**: örneğin yazıcı/yazarkasa cihazı
  tanımlamadıysanız "Köprü" maddesi atlanır. Yani yalnızca sizin için anlamlı
  adımları görürsünüz. **Mali entegrasyon** maddesi bir entegrasyon kalemi
  gerektirir (e-Fatura veya ÖKC/Yazarkasa — yıllık, lisans ön koşuluyla).
</Callout>
...
Kayıtta otomatik bir **"Main"** şubeniz oluşturulmuştur ve ilk şube ücretsizdir. Şubenizin adını, adresini ve saat dilimini gözden geçirin. Çok lokasyonlu çalışacaksanız, her ek şube için **Ek Şube** kalemini (yıllık, lisans ön koşuluyla) alıp şubelerinizi şimdi ekleyin.
...
- Tüm yönetim ekranlarının detaylı anlatımı için **[Yönetici Rehberi](/tr/admin-guide)**
- Ücretsiz çekirdek, lisans ve modül fiyatları için **[Lisans ve Fiyatlandırma](/tr/plans)**
- Cihazlar, köprü ve entegrasyonlar için **[Marketplace](/tr/marketplace)** ve **[Geliştirici / Entegrasyon](https://developer.hummytummy.com/tr/developer)**

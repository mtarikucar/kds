...
<Cards>
  <Cards.Card title="Kurulum & indirme" href="/tr/desktop/install" arrow />
  <Cards.Card title="Otomatik güncelleme" href="/tr/desktop/auto-update" arrow />
  <Cards.Card title="Donanım eşleştirme" href="/tr/desktop/hardware" arrow />
  <Cards.Card title="KDS / kiosk modu" href="/tr/desktop/kds-mode" arrow />
</Cards>
...
- **Sürüm kataloğu** — Tüm yayınlanmış kurulum paketleri sunucudaki `DesktopRelease`
  ...
  ait imzalı binary URL'sini döndürür. Bkz. [Kurulum & indirme](/tr/desktop/install).
- **Otomatik güncelleme** — Uygulama açılışta sunucuda yeni sürüm olup olmadığını kontrol
  eder; varsa imzayı doğrulayıp kurar. Bkz. [Otomatik güncelleme](/tr/desktop/auto-update).
- **Donanım (device-mesh)** — Yazıcı, nakit çekmece ve yazarkasa gibi cihazlar
  ...
  üzerinden cihaza iletilir. Bkz. [Donanım eşleştirme](/tr/desktop/hardware).

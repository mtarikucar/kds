...
| **[Online Sipariş](/tr/admin-guide/online-orders)** | `/admin/settings/online-orders` | Delivery platformları (Yemeksepeti/Getir vb.) | `deliveryIntegration` — PRO+ (veya `delivery_*`) |

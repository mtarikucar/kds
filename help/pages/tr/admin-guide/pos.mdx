...
**Menü yolu:** Kenar çubuğu (üst) → POS &nbsp;•&nbsp; **URL:** `/pos`
**Erişim:** ADMIN, MANAGER, WAITER
**Gereksinim:** `posAccess` — **ücretsiz çekirdeğe dahildir**
...
<Callout type="info">
  POS ve adisyon **ücretsiz çekirdeğe dahildir**: kredi kartı istenmez, lisans
  gerekmez, süre sınırı yoktur ve aylık sipariş sayısı sınırsızdır. Mutfak ekranı
  (KDS) da aynı şekilde ücretsizdir.
</Callout>

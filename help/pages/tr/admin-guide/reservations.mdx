...
**Gereksinim:** `reservationSystem` — **Rezervasyon Sistemi** modülü (990 ₺/yıl, lisans ön koşuluyla)
...
<Callout type="info">
  Rezervasyon sistemi, **Rezervasyon Sistemi** modülüyle (990 ₺/yıl; Bakım, Destek ve Güncelleme
  4.900 ₺/yıl ön koşuldur) açılır. Modül sizde yoksa menüde Rezervasyonlar görünmez ve
  doğrudan URL satın alma kartı gösterir.

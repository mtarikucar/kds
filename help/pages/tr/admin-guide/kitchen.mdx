...
**Gereksinim:** `kdsIntegration` — **ücretsiz çekirdeğe dahildir**
...
<Callout type="info">
  KDS **ücretsiz çekirdeğe dahildir**: lisans veya modül gerekmez, süre sınırı yoktur.
  POS gibi o da hiçbir ücretli kapının arkasında değildir.
</Callout>

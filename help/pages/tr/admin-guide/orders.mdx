...
**Gereksinim:** Ücretsiz çekirdeğe dahildir — POS (`posAccess`), mutfak akışı ve aylık sipariş sayısı sınırsızdır
...
| `TAKEAWAY` | Gel-al |
| `DELIVERY` | Adrese teslim (teslimat platformu entegrasyonu — ayrı satın alınır) |

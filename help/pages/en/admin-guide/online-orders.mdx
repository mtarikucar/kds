...
<Callout type="info">
  Each platform is configured on its own card. The catalogue carries a single
  line: Delivery Platform Integrations (₺2,499/year). Yemeksepeti, Getir,
  Trendyol Yemek and Migros Yemek all come in that one package. Semt is coming
  soon, free. Until you open a card, enter credentials and turn the

...
<Callout type="info">
  POS and table billing are **included in the free core**: no credit card, no licence,
  no time limit, and an unlimited number of monthly orders. The Kitchen Display (KDS)
  is free in exactly the same way.
</Callout>

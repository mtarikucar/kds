...
<Callout type="info">
  The reservation system is unlocked by the **Reservation System** module (₺990/year;
  the Maintenance, Support & Updates at ₺4,900/year is a prerequisite). Without the module,
  Reservations is hidden from the menu and the direct URL shows a purchase card.

...
**Menu path:** Sidebar (top) → Kitchen Display &nbsp;•&nbsp; **URL:** `/kitchen`
**Access:** ADMIN, MANAGER, KITCHEN
**Requires:** `kdsIntegration` — **included in the free core**
...
<Callout type="info">
  KDS is **included in the free core**: no licence, no module, no time limit. Like POS,
  it sits behind no paid gate at all.
</Callout>

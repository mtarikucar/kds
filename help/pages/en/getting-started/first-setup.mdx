...
<Callout type="info">
  The checklist is **context-aware**: if you haven't registered a printer/fiscal
  device, the "Bridge" item is skipped, so you only see the steps that are
  meaningful for you. The **Fiscal integration** item needs an integration item
  (e-Invoice or Fiscal Printer — annual, with the licence as a prerequisite).
</Callout>
...
Registration already created a **"Main"** branch for you, and the first branch is free. Review your branch's name, address, and time zone. If you'll run multiple locations, buy the **Extra Branch** item (annual, with the licence as a prerequisite) per branch and add them now.
...
- For the free core, the licence, and module prices, see **[Licence & Pricing](/en/plans)**

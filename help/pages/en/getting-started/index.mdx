...
The moment you sign up, the **free core** is live: POS and tabs, kitchen display (KDS), menu, tables and floor plan, QR menu, order management, cash drawer, basic reports, team and role management, customers, the device/branch panel, and custom branding. It is free forever, no card is required, and there is no trial stage. You only add paid modules if and when you need them.

...
**Access:** ADMIN, MANAGER  •  **Module required:** None — the store is part of the free core
...
<Callout type="info">
  The store is open on every account and needs no licence or module. Hardware is
  **bought outright** — there is no rental. The cart lives **only in your browser's memory**:

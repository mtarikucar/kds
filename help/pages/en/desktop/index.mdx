...
- **Auto-update** — On launch, the app checks the server for a newer release; if one
  exists it verifies the signature and installs it. See [Auto-update](/en/desktop/auto-update).

...
export class UpdateStockSettingsDto {
  @ApiPropertyOptional({
    description: "Enable auto-deduction of ingredients on order",
  })
  @IsBoolean()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Days before expiry to trigger low stock alert",
  })
  @IsNumber()
  @Min(0)
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: "Purchase order number prefix (letters/digits/-, 1-10 chars)",
  })
  @IsString()
  @IsOptional()
  @MaxLength(10)

...
export class HeatmapResponseDto {
  ...
  @ApiPropertyOptional({
    description: "High-value cells for quick reference",
    type: [HeatmapCellDto],
  })
...
export class TrafficFlowPathDto {
  ...
  @ApiProperty({
    description: "Sequence of points in the path",
    type: [TrafficFlowPointDto],
  })
...
export class TrafficFlowResponseDto {
  ...
  @ApiProperty({
    description: "Flow paths for visualization",
    type: [TrafficFlowPathDto],
  })
  ...
  @ApiPropertyOptional({
    description: "Entry point distribution",
    type: Object,
  })
...
export class CongestionResponseDto {
  ...
  @ApiPropertyOptional({
    description: "Recommendations to reduce congestion",
    type: [String],
  })

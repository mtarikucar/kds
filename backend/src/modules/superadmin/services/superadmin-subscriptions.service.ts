  ...
  async createPlan(
    ...
    const plan = await this.prisma.subscriptionPlan.create({
      data: {
        ...
        maxMonthlyAi3dModels: createDto.maxMonthlyAi3dModels ?? 0,
        ...
        externalDisplay: createDto.externalDisplay ?? false,
  ...
  async updatePlan(
    ...
    const plan = await this.prisma.subscriptionPlan.update({
      ...
      data: {
        ...
        maxMonthlyAi3dModels: updateDto.maxMonthlyAi3dModels,
        ...
        externalDisplay: updateDto.externalDisplay,

...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16 lg:h-20">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            />
            <span className={`text-xl lg:text-2xl font-bold transition-colors duration-300 ${textPrimary}`}>
              HummyTummy
            </span>
          </Link>
      ...
      {/* Mobile Menu */}
      <div
        className={`lg:hidden bg-white border-t border-slate-200 mobile-menu ${
          isMenuOpen ? 'is-open' : ''
        }`}
      >

# HummyTummy
## Modern Restoran Yönetim Platformu

---

# Yönetici Özeti

**HummyTummy**, restoran işletmelerinin operasyonel verimliliğini artıran, müşteri deneyimini iyileştiren ve gelirlerini maksimize eden kapsamlı bir bulut tabanlı yönetim sistemidir.

## Kimler İçin?

- **Bağımsız Restoranlar**: Tek lokasyonlu işletmeler
- **Kafeler ve Coffee Shop'lar**: Hızlı servis mekanları
- **Fast Casual Restoranlar**: Yarı self-servis işletmeler
- **Full-Servis Restoranlar**: Masa servisi yapan işletmeler
- **Restoran Zincirleri**: Çok lokasyonlu işletmeler
...
# Sektörde Karşılaşılan Sorunlar ve Çözümlerimiz

## 1. Yüksek Kurulum Maliyeti

### Problem
Geleneksel POS sistemleri:
- 5,000₺ - 20,000₺ arası donanım maliyeti
- Ek yazılım lisans ücretleri
- Uzman teknik destek gereksinimi
- Lokasyon değişikliğinde yeniden yatırım
...
### Problem
- Müşteri verilerini takip edememe
- Manuel sadakat kartları (kaybolma, unutulma)
- Müşteri davranışlarını analiz edememe
- Yeni müşteri kazanımında zorluk

### HummyTummy Çözümü
✓ **Otomatik Sadakat Programı** - Kademeli ödül sistemi (Bronz → Gümüş → Altın → Platin)
✓ **Dijital Puan Takibi** - Telefon numarasıyla otomatik puan biriktirme
...
### Problem
- El yazısı siparişlerde okuma hataları
- Mutfağa sipariş iletiminde gecikmeler
- Sipariş durumunu takip edememe
- Masaya yanlış yemek servisi

### HummyTummy Çözümü
✓ **Gerçek Zamanlı KDS** - Siparişler anında mutfak ekranında
✓ **Durum Takibi** - Beklemede → Hazırlanıyor → Hazır → Servis Edildi
...
### Problem
- Fiziksel menü baskı maliyetleri
- Menü güncellemelerinde zorluk
- COVID sonrası temassız hizmet talebi
- Garson çağırma zorluğu

### HummyTummy Çözümü
✓ **QR Dijital Menü** - Müşteriler telefonlarından menüye erişir
✓ **Anında Güncelleme** - Fiyat ve menü değişikliklerini hemen yansıtın
✓ **Direkt Sipariş** - Müşteriler telefondan sipariş verebilir
...
### Problem
- Manuel stok takibi
- Güncel stok durumunu bilememe
- Fire ve kayıpları takip edememe
- Kritik stok seviyelerinde uyarı alamama

### HummyTummy Çözümü
✓ **Otomatik Stok Takibi** - Satışlarla entegre envanter yönetimi
✓ **Düşük Stok Uyarıları** - Kritik seviyelerde otomatik bildirim
...
### Problem
- Gün sonu kapanışta uzun süre kaybı
- Hangi ürünlerin çok/az sattığını bilmeme
- Personel performans takibi yapamama
- Muhasebe için rapor hazırlamada zorluk

### HummyTummy Çözümü
✓ **Otomatik Z-Raporu** - Profesyonel gün sonu raporları
✓ **Satış Analitiği** - En çok satan ürünler, kategoriler
✓ **Personel Performansı** - Kişi bazında satış takibi
...
## 1. POS (Satış Noktası) Sistemi

### Sipariş Yönetimi
- **Çoklu Sipariş Türü**: Masada Ye / Paket Servis / Gel Al
- **Masa Yönetimi**: Masa planı, durum takibi (Boş / Dolu / Rezerve)
- **Hızlı Sipariş Girişi**: Kategori ve ürün bazlı kolay arayüz
- **Sipariş Modifikasyonları**: Ekstra malzeme, çıkarılacak malzemeler
- **İkili Onay Süreci**: Sipariş Oluştur → Ödeme Al
- **Masasız Mod**: Hızlı siparişler için masa atamadan sipariş

### Ödeme İşlemleri
- **Çoklu Ödeme Yöntemi**: Nakit, Kredi/Banka Kartı, Dijital Cüzdan
- **Bölünmüş Ödeme**: Farklı yöntemlerle ödeme alma
- **Bahşiş Yönetimi**: Bahşiş ekleme ve takibi
- **Kasa Yönetimi**: Kasa açılış/kapanış, para giriş/çıkış takibi
- **Fiş Yazdırma**: Otomatik fiş oluşturma

## 2. Mutfak Ekran Sistemi (KDS)

### Gerçek Zamanlı Sipariş İletimi
- **Anlık Bildirim**: Yeni siparişler mutfakta anında görünür
- **Sesli Uyarı**: Yeni sipariş geldiğinde ses bildirimi
- **Sipariş Kuyruğu**: Bekleyen siparişlerin sıralı listesi
- **Öncelik Sıralaması**: Acil siparişlerin vurgulanması

### Sipariş Durumu Yönetimi
- **Durum Adımları**: Beklemede → Hazırlanıyor → Hazır → Servis Edildi
- **Ürün Bazlı İşaretleme**: Her ürünü ayrı ayrı işaretleme
- **Hazırlık Süresi Takibi**: Ortalama hazırlık süreleri analizi
- **Geciken Sipariş Uyarısı**: Uzun süre bekleyen siparişlerin vurgulanması

### Mutfak Personeli Arayüzü
- **Dokunmatik Ekran**: Büyük, kullanıcı dostu butonlar
- **Sipariş Detayları**: Müşteri notları, özel istekler
- **Geçmiş Görüntüleme**: Tamamlanan siparişleri görme
- **Çoklu Ekran Desteği**: Farklı bölümler için ayrı ekranlar

## 3. QR Menü ve Müşteri Sipariş Sistemi

### Dijital Menü
- **QR Kod ile Erişim**: Her masa için özel QR kod
- **Mobil Optimize**: Telefon ekranı için optimize edilmiş tasarım
- **Görsel Zengin**: Ürün fotoğrafları ve detaylı açıklamalar
- **Kategori Bazlı Gezinme**: Kolay navigasyon
- **Arama Fonksiyonu**: Ürün ismine göre arama

### Müşteri Siparişi
- **Direkt Sipariş Verme**: Müşteriler garson beklemeden sipariş verir
- **Ürün Özelleştirme**: Modifikasyon seçenekleri (ekstra malzeme vb.)
- **Sepet Yönetimi**: Sipariş öncesi sepeti görme ve düzenleme
- **Sipariş Onayı**: Sipariş sonrası onay bildirimi

### Özelleştirme Seçenekleri
- **Marka Renkleri**: Ana renk, ikincil renk, arka plan rengi
- **Logo Ekleme**: Restoran logosu gösterimi
- **Font Seçimi**: Tipografi tercihleri
- **Düzen Stili**: Grid (Izgara) / Liste / Kompakt görünüm

### Müşteri Etkileşimi
- **Garson Çağırma**: Tek dokunuşla garson talebi
- **Hesap İsteme**: Hesap talebi gönderme
- **Sipariş Takibi**: Gerçek zamanlı sipariş durumu görüntüleme
- **Telefon Doğrulama**: Güvenli oturum yönetimi
...
- **Alışveriş Geçmişi**: Tüm siparişlerin kaydı
- **Harcama Analizi**: Toplam harcama, ortalama sepet, son ziyaret
...
- **Hoş Geldin Bonusu**: İlk kayıtta 50 puan
- **Doğum Günü Bonusu**: Doğum gününde 100 puan

### Referans Sistemi
- **Benzersiz Referans Kodu**: Her müşteriye özel kod
- **Çift Taraflı Ödül**: Hem referans veren hem de yeni müşteri kazanır
- **Durum Takibi**: Beklemede, Tamamlandı, Süresi Doldu
- **Ödül İzleme**: Referans geçmişi ve kazanılan ödüller

### Müşteri Analitiği
- **Segmentasyon**: Müşteri grupları ve etiketler
- **RFM Analizi**: Recency (Yenilik), Frequency (Sıklık), Monetary (Parasal Değer)
- **Kayıp Müşteri Analizi**: Geri gelmeyenlerin tespiti
...
- **Birim Yönetimi**: Adet, kg, lt gibi farklı birimler
- **Kritik Seviye**: Minimum stok seviyesi belirleme
- **Otomatik Güncelleme**: Satışlarla entegre stok azalması

### Stok Hareketleri
- **Giriş**: Tedarikçiden mal alımı
- **Çıkış**: Manuel kullanım veya fire
- **Düzeltme**: Sayım sonrası düzeltmeler
- **Hareket Geçmişi**: Kim, ne zaman, ne kadar? Tam kayıt

### Uyarı ve Bildirimler
- **Düşük Stok Uyarısı**: Kritik seviyeye geldiğinde bildirim
- **Stoksuz Ürünler**: Tükenmiş ürünlerin otomatik listesi
- **E-posta Bildirimleri**: Yöneticilere otomatik e-posta

### Raporlama
- **Stok Durum Raporu**: Anlık stok durumu
- **Hareket Raporu**: Belirli tarih aralığında hareketler
- **Fire Analizi**: Kayıp ve fire tutarları
...
- **Ödeme Yöntemi Dağılımı**: Nakit, kart, dijital ödeme oranları
- **Sipariş Türü Analizi**: Masada ye, paket servis, gel al oranları
- **Saatlik Satış Grafiği**: En yoğun saatlerin tespiti

### Ürün Raporları
- **En Çok Satan Ürünler**: Miktar ve tutar bazında
- **Kategori Performansı**: Hangi kategoriler daha çok satıyor?
- **Düşük Performanslı Ürünler**: Az satan ürünlerin tespiti
- **Kar Marjı Analizi**: Ürün bazlı karlılık

### Personel Raporları
- **Kişi Bazlı Satış**: Her personelin satış performansı
- **Sipariş Sayıları**: Personel başına sipariş adedi
- **Ortalama Sepet Değeri**: Personel bazlı ortalama satış
- **Performans Karşılaştırması**: En çok satan personel

### Z-Raporu (Gün Sonu Kapanışı)
- **Kapsamlı Özet**: Günün tam özeti
- **Kasa Mutabakatı**: Nakit sayım ve uyuşmazlık kontrolü
- **Tüm İşlemler**: Satışlar, iadeler, iptaller
- **Kategori Dökümü**: Kategori bazlı satış dökümü
...
### Rol Bazlı Erişim
- **ADMIN**: Tam yetki (Sahip/İşletme Müdürü)
- **MANAGER**: Yönetici yetkileri (Vardiya Müdürü)
- **WAITER**: Garson yetkileri (Sipariş alma, ödeme)
- **KITCHEN**: Mutfak personeli (Sadece KDS erişimi)
...
- **Yenileme Token**: 30 günlük oturum süresi
- **Şifre Hash**: bcrypt ile güvenli şifre saklama
- **Hız Sınırlama**: Brute-force koruması
- **CORS Koruması**: Yetkisiz erişim engelleme

## 9. Masaüstü Uygulaması (Tauri)

### Platform Desteği
- **Windows**: MSI ve NSIS yükleyiciler
- **macOS**: DMG imaj dosyası
...
- Native işletim sistemi entegrasyonu
- Daha güvenli güncelleme mekanizması
...
- **Oda Yönetimi**: Tenant bazlı veri izolasyonu

### Canlı Bildirimler
- **Mutfak Bildirimleri**: Yeni siparişler anında mutfakta
- **Garson Talepleri**: Müşteriler garson çağırınca anında bildirim
- **Hesap Talepleri**: Müşteriler hesap isteyince anında bildirim
- **Sipariş Durum Değişiklikleri**: Müşteriler sipariş durumunu canlı takip eder

### Bildirim Merkezi
- **Uygulama İçi Bildirimler**: Gerçek zamanlı bildirim merkezi
- **Okundu İşaretleme**: Bildirimleri okundu olarak işaretleme
- **Bildirim Geçmişi**: Tüm bildirimlerin kaydı
- **Öncelikli Bildirimler**: Önemli bildirimlerin vurgulanması
...
- Sipariş için garson çağırma gerekli
- Statik, güncellenemez içerik

### HummyTummy Farkı
✓ **Tam Müşteri Yolculuğu**: Görüntüle → Sipariş Ver → Takip Et → Puan Kazan
✓ **Özelleştirilebilir Tasarım**: Marka kimliği ile uyumlu renkler, logo, düzen
...
### Geleneksel Sistemler
- Sadakat sistemi yok veya temel puan takibi
- Manuel referans takibi
...
### Geleneksel Sistemler
- Sadece web tabanlı veya ağır Electron uygulamaları
- 100MB+ uygulama boyutu
...
- Manuel gün sonu kapanışı
- Muhasebe için uygun olmayan formatlar

### HummyTummy Farkı
✓ **Kapsamlı Gün Sonu**: Tam end-of-day raporlama
✓ **Kasa Mutabakatı**: Entegre kasa yönetimi
✓ **Personel Performansı**: Bireysel personel satış takibi
✓ **Uyumluluk Hazır**: Muhasebe için yapılandırılmış raporlar

## 6. Her Şey Gerçek Zamanlı

### Geleneksel Sistemler
- Polling tabanlı güncellemeler (gecikmeler)
- Manuel yenileme gerektiren ekranlar
- Zaman aşımlı veri

### HummyTummy Farkı
✓ **WebSocket Mimarisi**: Socket.IO ile anında güncellemeler
✓ **Canlı Mutfak Ekranı**: Siparişler anında mutfakta görünür
✓ **Müşteri Takibi**: Müşteriler sipariş durumunu gerçek zamanlı takip eder
✓ **Bildirimler**: Uygulama içi bildirim merkezi WebSocket ile

## 7. Gelişmiş Modifikasyon Sistemi
...
### HummyTummy Farkı
✓ **Esnek Yapılandırma**: Tekli/Çoklu seçim türleri
✓ **Doğrulama Kuralları**: Min/max seçimler, zorunlu/isteğe bağlı
...
### Geleneksel Sistemler
- Temel loglama
- Görsel hata ayıklama yok
- Performans izleme yok

### HummyTummy Farkı
✓ **Sentry Entegrasyonu**: Frontend + Backend izleme
✓ **Performans İzleme**: %10 trace örnekleme
✓ **Oturum Tekrarı**: Frontend hataları için görsel hata ayıklama
✓ **Otomatik Filtreleme**: Hassas veriler (şifreler, tokenler) hariç

## 10. Modern Teknoloji Stack

### Geleneksel Sistemler
- Eski altyapılar (PHP, jQuery, eski frameworkler)
- Yavaş geliştirme döngüleri
- Ölçeklenebilirlik sorunları

### HummyTummy Farkı
✓ **En Son Frameworkler**: React 18, NestJS 10, Prisma 6
✓ **Her Yerde TypeScript**: Frontend ve backend'de tip güvenliği
✓ **Modern Araçlar**: Vite, TanStack Query, Tailwind CSS
✓ **3D Açılış Sayfası**: Çekici pazarlama sayfası için Three.js
...
### Veri Güvenliği
✓ **SSL/TLS Şifreleme**: Tüm veri aktarımları şifreli
✓ **Şifre Hashleme**: bcrypt ile güvenli şifre saklama
✓ **JWT Token**: Güvenli kimlik doğrulama
✓ **SQL Injection Koruması**: Prisma ORM ile parametreli sorgular
✓ **XSS Koruması**: React otomatik kaçış + CSP başlıkları
✓ **CORS Koruması**: Yapılandırılmış origin kısıtlamaları

### Erişim Güvenliği
✓ **Rol Bazlı Yetkilendirme**: RBAC ile granüler erişim kontrolü
✓ **Hız Sınırlama**: Brute-force saldırılarına karşı koruma
✓ **E-posta Doğrulama**: 6 haneli kod ile hesap doğrulama
✓ **Güvenli Şifre Sıfırlama**: Token bazlı sıfırlama akışı
...
✓ **Redis Önbellek**: Sık erişilen veriler cache'lenir
✓ **Database İndeksleme**: Tüm foreign key ve sık sorgulanan alanlar
✓ **Bağlantı Havuzu**: Verimli database bağlantı yönetimi
✓ **Görsel Optimizasyonu**: Sharp ile otomatik görsel işleme
✓ **Code Splitting**: Vite ile hızlı yükleme, parça parça kod

### Ölçeklenebilirlik
✓ **Yatay Ölçeklendirme**: Stateless API tasarımı
✓ **Mikroservis Hazır**: Modüler NestJS mimarisi
✓ **CDN Desteği**: Statik dosyalar CDN'den sunulabilir
✓ **Multi-Tenant**: Tenant başına veri izolasyonu
...
### Her Yerden Erişim
✓ Herhangi bir cihazdan (bilgisayar, tablet, telefon)
✓ Herhangi bir işletim sisteminden (Windows, Mac, Linux, iOS, Android)
✓ Internet bağlantısı olan her yerden
✓ Kurulum ve güncelleme gerektirmez

### Otomatik Güncellemeler
✓ Yeni özellikler otomatik eklenir
✓ Güvenlik yamaları anında uygulanır
✓ Sistem bakımı kullanıcıyı etkilemez
✓ Sürüm uyumsuzluğu sorunu yok

### Donanım Bağımsız
✓ Pahalı server gerektirmez
✓ Yazıcı entegrasyonu için basit USB yazıcı yeterli
✓ Mevcut cihazlarınızı kullanabilirsiniz
✓ Taşınma durumunda sistem taşınması yok
...
### HummyTummy nedir?
HummyTummy, restoran işletmelerinin tüm operasyonlarını tek bir platformda yönetebileceği bulut tabanlı, modern bir restoran yönetim sistemidir. POS, mutfak ekranı, QR menü, sadakat programı, envanter yönetimi ve detaylı raporlama özelliklerini içerir.

### Hangi tür işletmeler için uygundur?
- Küçük kafeler (5-10 masa)
- Orta ölçekli restoranlar (10-50 masa)
- Restoran zincirleri (çoklu lokasyon)
- Fast-food zincirleri
- Coffee shop'lar
- Butik restoranlar

### Sistemi kullanmak için teknik bilgi gerekir mi?
...
Ortalama kurulum süresi 1-2 saattir. Bu süre şunları içerir:
- Hesap oluşturma (5 dk)
- Menü girişi (30-60 dk)
- Masa planı oluşturma (10 dk)
- Personel hesapları (10 dk)
- Test siparişleri (15 dk)

### Hangi cihazlar destekleniyor?
- **Bilgisayar**: Windows, macOS, Linux (masaüstü uygulaması veya web)
- **Tablet**: iPad, Android tabletler (web tarayıcı)
- **Telefon**: iOS, Android (web tarayıcı)
...
### QR menüde müşteriler nasıl sipariş verir?
1. Müşteri masadaki QR kodu okuttur
2. Telefon numarasını girer (doğrulama kodu gelir)
3. Menüyü görüntüler, ürünleri sepete ekler
4. Siparişi onaylar
5. Sipariş anında POS ve mutfak ekranında görünür

### Sadakat programı nasıl çalışır?
- Müşteri telefon numarasıyla sipariş verir
...
Evet. Verileriniz:
- SSL/TLS ile şifreli aktarılır
- Güvenli sunucularda saklanır
- Günlük otomatik yedeklenir
...
### 2. Kapsamlı Çözüm
✓ POS + KDS + CRM + Sadakat + Envanter + Raporlar
...
→ [hummytummy.com/signup](https://hummytummy.com/signup)
→ 2 dakikada kayıt olun
→ Kredi kartı gerektirmez

### Adım 2: Menünüzü Ekleyin
→ Kategori ve ürünlerinizi girin
→ Fotoğraf yükleyin
→ Fiyatları belirleyin

### Adım 3: QR Kodlarınızı Yazdırın
→ Sistem otomatik QR kod oluşturur
...
→ Test siparişi verin
→ KDS ve POS ekranlarını kontrol edin

### Adım 5: Canlıya Geçin!
→ Personele kısa eğitim verin
...
**HummyTummy Teknoloji A.Ş.**
Adres: [Adres bilgisi]
E-posta: info@hummytummy.com
Destek: support@hummytummy.com
Web: www.hummytummy.com

**Sosyal Medya:**
→ LinkedIn: linkedin.com/company/hummytummy
→ Instagram: @hummytummy
→ Twitter: @hummytummy

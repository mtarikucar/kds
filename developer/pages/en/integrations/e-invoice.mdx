...
- To view issued documents: **[Invoices](https://help.hummytummy.com/en/admin-guide/invoices)**.
- To manually resend / cancel records still in the queue or that have failed: **[Fiscal Recovery](https://help.hummytummy.com/en/admin-guide/fiscal-recovery)**.

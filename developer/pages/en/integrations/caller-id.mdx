...
First add the `caller_id_integration` add-on from the [Marketplace](https://help.hummytummy.com/en/marketplace). Once the add-on is active, the **Incoming Calls** menu becomes available.
...
With the add-on active, the **Incoming Calls** screen at **`/admin/caller-feed`** becomes available. This list shows recent calls, auto-refreshing every 10 seconds: time, provider, call type, number, matched customer, and duration. From a matched-customer row you can jump straight to the customer detail, or to the **[POS](https://help.hummytummy.com/en/admin-guide/pos)** screen when there's a related order.

## Related pages

- Integrations overview: **[Integrations](/en/integrations)**
- Adding add-ons: **[Marketplace](https://help.hummytummy.com/en/marketplace)** and **[Plans](https://help.hummytummy.com/en/plans)**
- Order-taking screen: **[POS (Sales Screen)](https://help.hummytummy.com/en/admin-guide/pos)**

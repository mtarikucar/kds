...
- **Connecting an external service:** [Integrations](/en/integrations) → delivery, SMS, e-Invoice, Caller ID
- **Integrator/developer:** [Developer / API](/en/developer) → [Partner Display API](/en/developer/partner-display) → [Webhooks](/en/developer/webhooks)

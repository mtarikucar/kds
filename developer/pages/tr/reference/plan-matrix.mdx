...
| Başlangıç | `BASIC` | ₺499 | ₺4.490 | — |
| Profesyonel | `PRO` | ₺1.299 | ₺12.990 | — |
| Kurumsal | `BUSINESS` | ₺2.999 | ₺29.990 | — |

_Ücretli tier'larda **ayrı deneme yoktur** (`trialDays = 0`); tek deneme, yukarıdaki özel **TRIAL** planıdır (7 gün) ve her yeni tenant orada başlar._

...
<Cards>
  <Cards.Card title="Hata Kodları" href="/tr/reference/error-codes" arrow>
  ...
  <Cards.Card title="Plan Matrisi" href="/tr/reference/plan-matrix" arrow>
    Özellik × plan tablosu ve plan limitleri (kullanıcı, şube, ürün …).
  </Cards.Card>
  <Cards.Card title="Sözlük" href="/tr/reference/glossary" arrow>

...
katmanları için [API Temelleri](/tr/developer/api-fundamentals) sayfasına bakın.
...
[API Temelleri](/tr/developer/api-fundamentals) sayfasındaki global katmanlara ek
...
- [Cihazlar ekranı](https://help.hummytummy.com/tr/admin-guide/devices) — yuva
  ...
  emekliye ayırma.
- [Donanım eşleştirme](https://help.hummytummy.com/tr/desktop/hardware) — yazıcı,
  nakit çekmece ve yazarkasa için operatör tarafı eşleştirme anlatımı.
- [KDS / kiosk modu](https://help.hummytummy.com/tr/desktop/kds-mode) — bir

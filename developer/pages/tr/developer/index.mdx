...
<Cards>
  <Cards.Card title="API Temelleri" href="/tr/developer/api-fundamentals" arrow>
...
- **Çekme** — REST uçlarını siz çağırırsınız (menü okuma, sipariş oluşturma,
  ...
  [API Temelleri](/tr/developer/api-fundamentals).
...
Her birinin tam ayrıntısı [API Temelleri](/tr/developer/api-fundamentals)
sayfasında.

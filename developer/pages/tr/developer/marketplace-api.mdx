...
kataloğda **kuruş** (`priceCents`) olarak tutulur: `299000` = ₺2.990,00. Tutarlar
...
| --- | --- | --- | --- | --- | --- | --- |
| `license_annual` | license | yıllık | ₺2.990 (`299000`) | `feature.license` | — | — |
| `advanced_reports` | module | yıllık | ₺1.290 (`129000`) | `feature.advancedReports` | ✅ | — |
| `module_inventory` | module | yıllık | ₺1.490 (`149000`) | `feature.inventoryTracking` | ✅ | — |
...
| `priority_support` | module | yıllık | ₺1.990 (`199000`) | `feature.prioritySupport` | ✅ | — |
| `delivery_yemeksepeti` | integration | yıllık | ₺2.490 (`249000`) | `integration.delivery` += `yemeksepeti`, `feature.deliveryIntegration` | ✅ | — |
| `delivery_getir` | integration | yıllık | ₺2.490 (`249000`) | `integration.delivery` += `getir`, `feature.deliveryIntegration` | ✅ | — |
| `delivery_trendyol_yemek` | integration | yıllık | ₺2.490 (`249000`) | `integration.delivery` += `trendyol_yemek`, `feature.deliveryIntegration` | ✅ | — |
| `fiscal_efatura` | integration | yıllık | ₺1.990 (`199000`) | `integration.fiscal` += `efatura` | ✅ | — |
